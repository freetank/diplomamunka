...
\input{tex/Szabalyok/41ERL-PARSING}
...
\input{tex/Szabalyok/41ERL-EXAMPLE-KRESULT}

Először is a Value alfajtája lesz a \textit{KResult} K specifikus fajtának.

\input{tex/Szabalyok/41ERL-EXAMPLE-PREPROCESSING}
...
\input{tex/Szabalyok/41ERL-EXAMPLE-FUNCALL}
