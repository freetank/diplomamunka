...
%\begin{tcolorbox}
%\footnotesize \uppercase{module} \large TOKENS-PARSING
%\begin{align*}
%    syntax & UnquotedAtom &::= z	     &[token, autoReject, notInRules] \\
%    syntax & QuotedAtom &::= zzz                   &[token, notInRules]\\
%    %syntax &Atom &::= UnquotedAtom | Bool &\\
%    %syntax &Pid &::= "<"Int"."Int"."Int">"                 &[autoReject, strict]\\
%    %syntax &Joker & &\\
%    %syntax &Variable &::= Joker &\\
%\end{align*}
%\footnotesize \uppercase{endmodule}
%\end{tcolorbox}
