...
\kruleReqInBox{
  ...
  {{{{}\terminal{count}({\variable[Values]{Xs}{}})}\mathrel{{=}{=}_{\scriptstyle\it Int}}{{}\terminal{count}({\variable[Values]{Ys}{}})}} \wedge_{\scriptstyle\it Bool} \newline {{{}\terminal{count}({\variable[Values]{Xs}{}})}\mathrel{>_{\scriptstyle\it Int}}{\constant[\#Int]{0}}} \wedge_{\scriptstyle\it Bool} \newline {{{}\terminal{count}({\variable[Values]{Ys}{}})}\mathrel{>_{\scriptstyle\it Int}}{\constant[\#Int]{0}}}}{}{\kattribute{structural}}{}
