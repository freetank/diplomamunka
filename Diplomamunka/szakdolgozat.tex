...
Mintaillesztés nem csak az egyenlőség jellel lehetséges, hanem különböző vezérlési szerkezetekben is, mint például a \textit{receive} és a \textit{case}, amire később láthatunk példát.
